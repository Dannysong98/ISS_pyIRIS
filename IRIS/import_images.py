...
def decode_data_Lee(f_cycles):
    ...
    for cycle_id in range(0, len(f_cycles)):
        ...
        channel_T = imread('/'.join((f_cycles[cycle_id], 'f3_T_' + cycle + '_C_01.tif')), IMREAD_GRAYSCALE)
        channel_C = imread('/'.join((f_cycles[cycle_id], 'f3_T_' + cycle + '_C_02.tif')), IMREAD_GRAYSCALE)
        channel_G = imread('/'.join((f_cycles[cycle_id], 'f3_T_' + cycle + '_C_03.tif')), IMREAD_GRAYSCALE)
